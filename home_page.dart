...
import 'package:classico/album_page.dart';
      ...
      title: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            Icon(Entypo.list, color: Colors.white),
          ],
        ),
      ),);
  }
                                ...
                                child: GestureDetector(
                                  ...
                                  children: [
                                    Text(song_type_1[index], style: TextStyle(
                                        fontSize: 15,
                                        color: activeMenu1 == index ?  Colors.grey : null,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(song_type_2[index], style: TextStyle(
                                        fontSize: 15,
                                        color: activeMenu2 == index ?  Colors.grey : null,
                                        fontWeight: FontWeight.w600),
                                    ),
                                    SizedBox(height: 3,),
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Container(
                                    width: 180,
                                    child:
                                    Text(songs[index+5]['description'],
                                      maxLines: 1,
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                          fontSize: 12,
